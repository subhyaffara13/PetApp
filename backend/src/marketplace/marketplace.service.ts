...
const INITIAL_HAIFA_SHOPS = [
  {
    ...
    phone: '04-812-3456',
    tags: ['Delivery', 'Pickup Only', 'Food', 'Toys', 'Grooming'],
    rating: 4.8,
    isRegistered: true,
  ...
  {
    _id: 'shop-haifa-6',
    name: 'Krayot Dog & Cat Superstore (Info Only)',
  ...
  {
    _id: 'shop-haifa-7',
    name: 'Haifa Pet Boutique Horev (Info Only)',
