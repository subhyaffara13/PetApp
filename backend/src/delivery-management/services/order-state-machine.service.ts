...
export class OrderStateMachineService {
  private static readonly VALID_TRANSITIONS: Record<StoreOrderStatus, StoreOrderStatus[]> = {
    ...
    ready_for_pickup: ['courier_assigned', 'out_for_delivery', 'cancelled', 'failed'],
   ...
   */
  public canTransition(current: StoreOrderStatus, target: StoreOrderStatus): boolean {
   ...
   */
  public shouldTriggerDaaS(status: StoreOrderStatus, deliveryMode: DeliveryMode): boolean {
