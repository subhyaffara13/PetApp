        ...
        >
          <button
            ...
            style={{
              ...
              borderRadius: '9999px',
              border: activeTab === 'pets' ? '1px solid var(--color-primary, #38bdf8)' : '1px solid var(--color-border)',
              background: activeTab === 'pets' ? 'rgba(56, 189, 248, 0.15)' : 'var(--color-bg-elevated)',
              color: activeTab === 'pets' ? 'var(--color-primary, #38bdf8)' : 'var(--color-text-secondary)',
              fontWeight: 700,
              fontSize: '0.85rem',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              ...
              padding: '0.5rem 1.1rem',
              borderRadius: '9999px',
              border: activeTab === 'purchases' ? '1px solid var(--color-primary, #38bdf8)' : '1px solid var(--color-border)',
              background: activeTab === 'purchases' ? 'rgba(56, 189, 248, 0.15)' : 'var(--color-bg-elevated)',
              color: activeTab === 'purchases' ? 'var(--color-primary, #38bdf8)' : 'var(--color-text-secondary)',
              fontWeight: 700,
              fontSize: '0.85rem',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
          ...
          <button
            ...
            style={{
              ...
              padding: '0.5rem 1.1rem',
              borderRadius: '9999px',
              border: activeTab === 'archived' ? '1px solid var(--color-primary, #38bdf8)' : '1px solid var(--color-border)',
              background: activeTab === 'archived' ? 'rgba(56, 189, 248, 0.15)' : 'var(--color-bg-elevated)',
              color: activeTab === 'archived' ? 'var(--color-primary, #38bdf8)' : 'var(--color-text-secondary)',
              fontWeight: 700,
              fontSize: '0.85rem',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
